...
sqlplus alp_fgi_demo/alp_fgi_demo@alp-3 @%COUGAAR_INSTALL_PATH%\fgi\data\delete_rules.sql

sqlplus alp_fgi_demo/alp_fgi_demo@alp-3 @%COUGAAR_INSTALL_PATH%\fgi\data\qual_rule.sql

sqlplus alp_fgi_demo/alp_fgi_demo@alp-3 @%COUGAAR_INSTALL_PATH%\fgi\data\qual_rule_test.sql

sqlplus alp_fgi_demo/alp_fgi_demo@alp-3 @%COUGAAR_INSTALL_PATH%\fgi\data\restore_fund_buffer.sql
