/* $Header: /opt/rep/cougaar/glm/glm/src/org/cougaar/domain/mlm/ui/tpfdd/gui/view/Attic/TPFDDSwingWorker.java,v 1.3 2001-10-17 19:07:05 gvidaver Exp $ */
...
public abstract class TPFDDSwingWorker
{
     ...
     * and then exit.
     */
    public TPFDDSwingWorker(TPFDDShell parent)
    {
	this.parent = parent;
