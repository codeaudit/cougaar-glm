/* $Header: /opt/rep/cougaar/glm/glm/src/org/cougaar/domain/mlm/ui/tpfdd/gui/view/Attic/TreeTableCellRenderer.java,v 1.3 2001-10-17 19:07:06 gvidaver Exp $ */
...
public class TreeTableCellRenderer extends JTree implements TableCellRenderer 
{
    ...
    public TreeTableCellRenderer(TreeModel model, JTreeTable treeTab, Font myFont)
    { 
	super(model);
	expandRow(0);
	treeTable = treeTab;
