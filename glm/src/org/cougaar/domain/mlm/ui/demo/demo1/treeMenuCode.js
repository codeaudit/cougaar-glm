...
function treeMenuDisplay() {
  ...
  treeMenuDocument.writeln('<style type="text/css">a {text-decoration:none;} all.selected {background-color:' + treeMenuHiBg + ';color:' + treeMenuHiFg + ';}</style>');
  treeMenuDocument.writeln('</head>');
  ...
  treeMenuDocument.write('<font face="MS Sans Serif,Arial,Helvetica" size=1>&nbsp;' + treeMenuRoot + '&nbsp;</font>');
...
function treeMenuDisplayItem(item) {
  ...
  if (item.index == treeMenuSelected)
    treeMenuDocument.write('<font face="MS Sans Serif,Arial,Helvetica" size=1><span class="selected">&nbsp;' + item.text + '&nbsp;</span></font>');
  else
    treeMenuDocument.write('<font face="MS Sans Serif,Arial,Helvetica" size=1> ' + item.text + '</font>');
