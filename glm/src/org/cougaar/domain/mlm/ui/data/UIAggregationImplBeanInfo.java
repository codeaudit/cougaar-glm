...
public class UIAggregationImplBeanInfo extends SimpleBeanInfo {

  public PropertyDescriptor[] getPropertyDescriptors() {
    PropertyDescriptor[] pd = new PropertyDescriptor[2];
    int i = 0;
    try {
      Class beanClass = Class.forName("org.cougaar.domain.mlm.ui.data.UIAggregationImpl");
      pd[i++] = new IndexedPropertyDescriptor("parentTask",
                                              beanClass,
                                              "getParentTasks", null,
                                              "getParentTask", null);
