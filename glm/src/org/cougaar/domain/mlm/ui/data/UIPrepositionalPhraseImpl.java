...
public class UIPrepositionalPhraseImpl implements UIPrepositionalPhrase {
  ...
  */
  ...
  public String getUIAssetUUID() {
    ...
    try {
      assetClass = Class.forName("org.cougaar.domain.planning.ldm.asset.Asset");
    } catch (Exception e) {
  ...
  public UILocation getLocation() {
    ...
    try {
      locationClass = Class.forName("org.cougaar.domain.planning.ldm.plan.Location");
    } catch (Exception e) {
      System.out.println(e);
    }
  ...
  public UISchedule getSchedule() {
    ...
    try {
      scheduleClass = Class.forName("org.cougaar.domain.planning.ldm.plan.Schedule");
    } catch (Exception e) {
      System.out.println(e);
    }
