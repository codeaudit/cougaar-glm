...
public class UIReportImplBeanInfo extends SimpleBeanInfo {

  public PropertyDescriptor[] getPropertyDescriptors() {
    PropertyDescriptor[] pd = new PropertyDescriptor[2];
    int i = 0;
    try {
      Class beanClass = Class.forName("org.cougaar.domain.mlm.ui.data.UIReportImpl");
      pd[i++] = new PropertyDescriptor("infoText",
                                       beanClass,
                                       "getText",
                                       null);
      pd[i++] = new PropertyDescriptor("infoDate",
                                       beanClass,
                                       "getDate", 
                                       null);
