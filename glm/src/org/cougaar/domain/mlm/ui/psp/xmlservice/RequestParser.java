...
public class RequestParser {
  ...
  static String[] classNames = { "org.cougaar.domain.planning.ldm.plan.Aggregation", 
        "org.cougaar.domain.planning.ldm.plan.Allocation", 
        "org.cougaar.domain.planning.ldm.plan.Disposition",
        "org.cougaar.domain.planning.ldm.asset.Asset",
        "org.cougaar.domain.planning.ldm.plan.AssetTransfer", 
        "org.cougaar.domain.planning.ldm.plan.Expansion", 
        "org.cougaar.domain.planning.ldm.plan.PlanElement",
        "org.cougaar.domain.planning.ldm.policy.Policy", 
        "org.cougaar.domain.planning.ldm.plan.Task", 
        "org.cougaar.domain.planning.ldm.plan.Workflow" };
  ...
  private static void initCommands() throws RuntimePSPException {
    try {
      BeanInfo commandInfo = Introspector.getBeanInfo(
          Class.forName("org.cougaar.domain.mlm.ui.psp.xmlservice.CommandHandler"), 
