 ...
 * @since 1/28/01
 **/
public class LegsDataFactory implements DeXMLableFactory{
  ...
  public DeXMLable beginSubObject(DeXMLable curObj, String name, 
    ...
    if(curObj==null && name.equals(LegsData.NAME_TAG)){
      return new LegsData();
    }else if((curObj instanceof LegsData)&&
	     name.equals(Leg.NAME_TAG)){
      return new Leg();
    }
    return null;
  }
