...
*
*   Copyright 2001 by
*             BBN Technologies, A Verizon Company, all rights reserved.
*
* --------------------------------------------------------------------------*/
...
import org.cougaar.domain.glm.ldm.asset.AssetConsumptionRatePG;
import org.cougaar.domain.glm.ldm.asset.BulkPOL;
import org.cougaar.domain.glm.ldm.oplan.OpTempo;
	...
	protected void checkSchedule(Schedule sched) {
		...
		while (elements.hasMoreElements()) {
	    	...
	    	if (!(el.getClass().getName().equals
				("org.cougaar.domain.glm.ldm.plan.ObjectScheduleElement"))) {
