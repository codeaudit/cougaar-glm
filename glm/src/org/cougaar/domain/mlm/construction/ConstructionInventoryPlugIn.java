...
import org.cougaar.domain.glm.plugins.inventory.InventoryPlugIn;
...
public class ConstructionInventoryPlugIn extends InventoryPlugIn {
    ...
    public Inventory createInventory(String supplytype, Asset resource) {
      ...
      InventoryBG bg = null;
      NewInventoryPG invpg = (NewInventoryPG)org.cougaar.domain.glm.ldm.asset.PropertyGroupFactory.newInventoryPG();
      ...
      if (reportBaseDate != null) {
        NewReportSchedulePG nrsp = org.cougaar.domain.glm.ldm.asset.PropertyGroupFactory.newReportSchedulePG();
