...
import org.cougaar.domain.glm.util.AllocatorHelper;
...
import org.cougaar.domain.glm.plugins.projection.ConsumerSpec;
 ...
 * @version $Id: ConstructionGenerateDemandProjector.java,v 1.2 2001-04-10 17:39:07 bdepass Exp $
 **/
        ...
        try {
	        ...
	        rset = stmt.executeQuery(query.toString());
                ...
                while (rset.next ()) {
                   ...
                   NewSupplyClassPG pg = (NewSupplyClassPG)org.cougaar.domain.glm.ldm.asset.PropertyGroupFactory.newSupplyClassPG();
                   ...
                   NewTypeIdentificationPG tipg = (NewTypeIdentificationPG)org.cougaar.domain.glm.ldm.asset.PropertyGroupFactory.newTypeIdentificationPG();
