...
import org.cougaar.domain.planning.ldm.measure.Duration;
...
//                         + c.getUID());
  ...
  private Preference createTypedPreference(Capacity capacity, double qty) {
    ...
    org.cougaar.domain.planning.ldm.measure.Capacity measureCapacity;
    ...
    if (capacity.getScheduledContentPG().getAsset() instanceof BulkPOL) {
      ...
      measureCapacity = new org.cougaar.domain.planning.ldm.measure.Capacity(myScalar, new Duration(1, Duration.DAYS));
