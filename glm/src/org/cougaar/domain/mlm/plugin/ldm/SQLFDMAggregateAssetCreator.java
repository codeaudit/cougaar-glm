...
public class SQLFDMAggregateAssetCreator extends PeriodicQuery 
						 //implements org.cougaar.domain.mlm.plugin.ldm.PropertyProvider
{
...
//  	System.out.println(myClusterIdentifier.getAddress() + ": " + "Creating aggregate asset : " + tid + " " +count  + " " + nomenclature);
	...
	ClassVIIMajorEndItem proto = 
	    (ClassVIIMajorEndItem)ldmf.createPrototype("org.cougaar.domain.glm.ldm.asset.ClassVIIMajorEndItem", tid);
