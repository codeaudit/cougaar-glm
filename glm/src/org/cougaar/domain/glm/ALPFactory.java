...
public class ALPFactory implements org.cougaar.domain.planning.ldm.Factory {
  public ALPFactory(LDMServesPlugIn ldm) {
    ...
    rf.addAssetFactory(new org.cougaar.domain.glm.asset.AssetFactory());
    rf.addPropertyGroupFactory(new org.cougaar.domain.glm.asset.PropertyGroupFactory());
  }
   ...
   * @return Capability
   * @see org.cougaar.domain.glm.plan.Capability for a list of valid values
   **/
   ...
   * @see org.cougaar.domain.glm.plan.CapacityScheduleElement
   **/
   ...
   *  @see org.cougaar.domain.glm.plan.LaborSchedule
   *  @see org.cougaar.domain.glm.plan.QuantityScheduleElements
   *  @see org.cougaar.domain.glm.plan.RateScheduleElements
   **/
   ...
   * @see org.cougaar.domain.planning.ldm.plan.ScheduleType
   * @see org.cougaar.domain.glm.plan.QuantityRangeScheduleElement
   **/
