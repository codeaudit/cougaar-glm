 ...
 * @version $Id: ForcePackageBeanInfo.java,v 1.1 2000-12-20 18:18:13 mthome Exp $
 */
public class ForcePackageBeanInfo extends SimpleBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    ...
    int i = 0;
    try {
      Class myClass = Class.forName("org.cougaar.domain.glm.ldm.oplan.ForcePackage");
      ...
      System.out.print("ForcePackageBeanInfo ");
      e.printStackTrace();
    }
    return null;
  }
