...
import org.cougaar.domain.glm.ldm.Constants.Role;
...
public abstract class DecorationPlugIn extends SimplePlugIn {
    ...
    public org.cougaar.domain.planning.ldm.plan.Role consumerRole_ = null;
    ...
    public static final String NEW_CUSTOMER_WAIT_PROP = "org.cougaar.domain.glm.plugins.inventory.newCustomerWait";
