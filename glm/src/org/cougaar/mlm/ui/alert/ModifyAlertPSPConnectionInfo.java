...
public class ModifyAlertPSPConnectionInfo implements PSPConnectionInfo {
  ...
  private static final String PSP_ID = "MODIFYALERT.PSP";
  ...
  private static ModifyAlertPSPConnectionInfo myCurrent = null;

  public static ModifyAlertPSPConnectionInfo current() {
    if (myCurrent == null) {
      myCurrent = new ModifyAlertPSPConnectionInfo();
    } 
