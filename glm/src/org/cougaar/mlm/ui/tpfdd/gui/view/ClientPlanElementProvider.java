/* $Header: /opt/rep/cougaar/glm/glm/src/org/cougaar/mlm/ui/tpfdd/gui/view/Attic/ClientPlanElementProvider.java,v 1.1 2001-12-27 22:44:25 bdepass Exp $ */
...
import org.cougaar.mlm.ui.tpfdd.gui.model.SimpleRowModelProducer;
import org.cougaar.mlm.ui.tpfdd.gui.model.SimpleItemPoolModelProducer;
import org.cougaar.mlm.ui.tpfdd.gui.model.ItemPoolModelListener;
import org.cougaar.mlm.ui.tpfdd.gui.model.RowModelListener;
...
public class ClientPlanElementProvider extends PlanElementProvider
{
    ...
    public ClientPlanElementProvider(ClusterCache clusterCache, TaskFilter filter,
				     boolean cannedMode, boolean isMaster)
    {
	super(clusterCache, filter, cannedMode);
	...
	else if ( psp.equals(PSPClientConfig.ItineraryPSP_id) )
	    producer = clusterCache.getItineraryProducer(name, false);
	else {
