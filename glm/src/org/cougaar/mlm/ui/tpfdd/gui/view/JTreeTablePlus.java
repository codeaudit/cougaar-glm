...
import org.cougaar.mlm.ui.tpfdd.util.SwingQueue;
...
public class JTreeTablePlus extends JTable implements ActionListener, SwingUpdate
{
    private TestNewView parentView;
    private ClientPlanElementProvider parentProvider;
    private ClusterCache clusterCache;

    protected TreeTableCellRendererPlus tree;
    ...
    public JTreeTablePlus(TreeTableModel treeTableModel, ClusterCache clusterCache,
		      ClientPlanElementProvider parentProvider, TestNewView parentView, Font myFont)
    {
	super();
	setFont(myFont);
	...
	tree = new TreeTableCellRendererPlus(treeTableModel, this, myFont); 
	...
	if ( clusterQuery == null ) {
	    try {
		clusterQuery = new ClusterQuery(parentProvider, clusterCache.getDemandHost ());
