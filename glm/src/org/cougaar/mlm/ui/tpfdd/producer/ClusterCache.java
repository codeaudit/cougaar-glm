...
import org.cougaar.mlm.ui.tpfdd.xml.ClusterList;
...
public class ClusterCache
{
  ...
  public ClusterCache(boolean clientMode, String allowOrgList) {
	...
	String clusterNameProp = System.getProperty ("org.cougaar.mlm.ui.tpfdd.producer.rootCluster");
	if (clusterNameProp != null)
	  rootCluster = clusterNameProp;
	if (debug) 
	  System.out.println ("ClusterCache.ctor - root cluster now " + rootCluster);
	String defaultHostNameProp = System.getProperty ("org.cougaar.mlm.ui.tpfdd.producer.defaultHostName");
	if (defaultHostNameProp != null) {
	  defaultHostName = defaultHostNameProp;
	  host = defaultHostName;
	}

	String defaultDemandHostProp = System.getProperty ("org.cougaar.mlm.ui.tpfdd.producer.defaultDemandHost");
	if (defaultDemandHostProp != null) {
	  defaultDemandHost = defaultDemandHostProp;
	}

	noHostPrompt = 
	  ("true".equals(System.getProperty ("org.cougaar.mlm.ui.tpfdd.producer.noHostPrompt")));
  ...
  private class ClusterNameHandler extends DefaultHandler {
	...
	if ( clusterName.equals("Aggregation") )
	    producer = new LogPlanProducer(host, Server.CLIENT_PORT, this);
