...
package org.cougaar.mlm.ui.planviewer.supply;
...
public class EquipmentInfo {
  ...
  static final String[][] superiors = {
    ...
    { "MG1", "Class III" },
    { "F76", "Class III" },
    { "People", "Class VII" }, // remove this line to not show people in chart
    { "Passengers", "Class VII" }, // remove to not show passengers in chart
    { "Class VII", "Category" },
