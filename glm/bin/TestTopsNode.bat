...
set MYPROPERTIES=-Dorg.cougaar.system.path=%COUGAAR3RDPARTY% -Dorg.cougaar.install.path=%COUGAAR_INSTALL_PATH% -Dorg.cougaar.config.path=%TOPS_TEST_PATH%\data;%TOPS_TEST_PATH%\data\PROTOTYPES;%TOPS_TEST_PATH%\data\CLUSTERINPUT; -Duser.timezone=GMT -Dorg.cougaar.core.agent.startTime=08/10/2005 -Dorg.cougaar.planning.ldm.lps.ComplainingLP.level=0 -Dorg.cougaar.core.agent.SharedPluginManager.watching=false
...
set LIBPATHS=%LIBPATHS%;%COUGAAR_INSTALL_PATH%\lib\jcchart.jar
...
set LIBPATHS=%LIBPATHS%;%COUGAAR_INSTALL_PATH%\lib\xercesImpl.jar
set LIBPATHS=%LIBPATHS%;%COUGAAR_INSTALL_PATH%\lib\xml-apis.jar
